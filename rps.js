...
function getHumanChoice() {
  ...
  // Create conditional statement to validate user inputs are rock, paper, scissors.
  // Use while loop to request a valid input
  while (choice !== "rock" && choice !== "paper" && choice !== "scissors") {
    choice = prompt("Input invalid. Please choose rock, paper, or scissors: ");
    choice = choice.toLowerCase();
  }
  return choice;
}
